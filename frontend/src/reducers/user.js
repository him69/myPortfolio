...
export const updateReducer = createReducer({}, {
    ...
    ADD_HOMEPROJECT_REQUEST: (state) => {
        state.loading = true
    },
    ADD_HOMEPROJECT_SUCCESS: (state, action) => {
        state.loading = false;
        state.message = action.payload;
    },
    ADD_HOMEPROJECT_FAILURE: (state, action) => {
        state.loading = false;
        state.error = action.payload;

    },
    DELETE_HOMEPROJECT_REQUEST: (state) => {
        state.loading = true
    },
    DELETE_HOMEPROJECT_SUCCESS: (state, action) => {
        state.loading = false;
        state.message = action.payload;
    },
    DELETE_HOMEPROJECT_FAILURE: (state, action) => {
        state.loading = false;
        state.error = action.payload;
